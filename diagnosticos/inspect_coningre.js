...
console.log("=== COLUMNAS DE coningre ===");
const cols = runSqlcmdQuery("SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'coningre'");
console.log(cols.map(c => c.COLUMN_NAME));

console.log("\n=== REGISTROS DE coningre ===");
const data = runSqlcmdQuery("SELECT * FROM coningre");
console.log(data);
